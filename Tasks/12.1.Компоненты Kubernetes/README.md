...
- Для реализации проекта необходимо всего:
  - 17 процессоров
  - 30,25 оперативной памяти

- Расчёт ресурсов с учётом миграций и выхода ноды из строя
  - CPU: 17 + 40% = 24 (с окрухлением в дольшую сторону)
  - RAM: 30,25 + 40% = 43 (с окрухлением в дольшую сторону)
...
### Итого:
 ...
 - Необходимо: 3 Worker Node, характеристики одной ноды 9 CPU, 16 RAM
 - Необходимо: 3 Control Node, характеристики одной ноды 2 CPU, 2 RAM
